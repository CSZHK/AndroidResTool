 ...
 */
	 ...
	 * @return
	 */
	public  static ArrayList<ResourceClass>  getValuesDirFile(ArrayList<ResourceClass> list){
		ArrayList<ResourceClass> valueFileList = new ArrayList<ResourceClass>();
		for(ResourceClass res : list){
			if(res.resourcePath.contains("res" + File.separator + "values")){
	 ...
	 * @param list
	 */
	public static void printResList(ArrayList<ResourceClass>  list){
		if(null == list){
			return;
		}
		for(ResourceClass res : list){
